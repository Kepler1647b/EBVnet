...
from EBV_classifier.Dataloader_train import ZSData
...
if __name__ == '__main__':
    ...
    parser.add_argument("--Save_path", dest='save_path', default='../../EBVnet_checkpoints', help='the path to save the training result')
